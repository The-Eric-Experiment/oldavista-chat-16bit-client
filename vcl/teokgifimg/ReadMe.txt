...
* Can decode and display animated GIF's
  ...
  Animator. Also supports the "Remove To Previous Image" animation option.
...
* Win16.exe    - Contains all the files you'll need for installation on
                 16-bit Windows (Delphi 1)
* Win32.exe    - Contains all the files you'll need for installation on
                 32-bit Windows (Delphi 2-5, C++Builder 1-4).
...
Part of the declaration of TGIFImage looks like this:
  ...
  published
    ...
    property Graphic; // only used at design-time
    property Loop           : Boolean         ;
    property Opaque         : Boolean         ;
    property Speed          : Integer         ;
    property Stretch        : Boolean         ;
    property StretchRatio   : Boolean         ;
    property StretchBigOnly : Boolean         ;
...
* Graphic
  This property is only used at design-time to fascilitate the easy loading of images.
...
* StretchBigOnly : Boolean
  If enabled, it causes the Stretch or StretchRatio properties to only take effect when
  the image is too large to be displayed in the allocated space.
...
a 'Refresh' option which just updates the display in case it got garbled. New in version 3.0 is
the Graphic property which does what the 'Load...' option on the popup-menu does (in case you
can't access the popup-menu).
