...
May 24, 2005  V2.26 Bjornar Nielsen <bjornar@sentinel.no> added HeaderCc
              property.
...
const
    Pop3CliVersion     = 226;
    CopyRight : String = ' POP3 component (c) 1997-2005 F. Piette V2.27 ';
{$IFDEF VER80}
...
begin
    ...
    if FHeaderPart then begin
        ...
        else if FLastResponse[1] in [' ', #9] then begin
            { Continuation line }
