...
const
    THttpServerVersion = 137;
    CopyRight : String = ' THttpServer (c) 1999-2005 F. Piette V1.37 ';
...
begin
    ...
    if FState = hcRequest then begin
        ...
        FKeepAlive             := FALSE;  {Bjornar, default value. This is set to true when header indicates keep-alive.
                                           Use this value to deside when to shut down the socket}
    ...
    if FRcvdLine = '' then begin
        ...
        {else if FMethod = 'GET' then                            10/02/2004 Bjornar}
