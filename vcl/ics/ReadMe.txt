...
At the time of this writing, there are still a few bugs in D2005 IDE.
To see all the ICS component icons, you must select the middle icon size
in tools/otions/tools palette.
